    ...
    <div class="header__container">
      <h1 class="header__container__title">
        <span class="header__container__title__line">
          <span class="header__container__title__line__content">Muhammad</span>
        </span>
        <span
          class="header__container__title__line header__container__title__line--pl"
        >
          <span class="header__container__title__line__content">Ahmad</span>
        </span>
      </h1>
      <p class="header__container__subtitle">
        <span class="header__container__subtitle__char"
          >Chief Executive Officer - GXSoftwares</span
        >
      </p>
    </div>
